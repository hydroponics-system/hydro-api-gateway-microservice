package com.hydro.api.gateway.validator;
...
import com.hydro.api.gateway.domain.abstracts.CommonTokenValidator;
...
public class EndpointInboundValidator extends CommonTokenValidator {
    ...
    private List<AntPathRequestMatcher> excludedMatchers() {
        ...
        matchers.add(new AntPathRequestMatcher("/api/system-app/api/system-app/system/register", "POST"));
